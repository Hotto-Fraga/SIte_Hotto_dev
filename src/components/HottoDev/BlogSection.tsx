...
const blogPreviews: BlogPreview[] = [
	{
		id: 1,
		title: 'Romania Trip',
		description: 'A trip through Bucharest and Brasov with friends.',
		badge: 'Romania Post',
		thumb: '/images/others/romaniahomesection.png',
		href: '/blog/romania',
	},
	{
		id: 2,
		...
		badge: 'Brazil Post',
		thumb: '/images/others/brazilhomesection.png',
		href: '/blog/brasil',
	},
	{
		id: 3,
		title: 'Italy Trip',
		description: 'A trip through several italian cities.',
		badge: 'Italy Post',
		thumb: '/images/others/italyhomesection.png',
		href: '/blog/italia',
	},
]
			...
			<div className="mx-auto max-w-6xl">
				...
				<div className="grid grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
					{blogPreviews.map((blog) => (
						...
						>
							<img src={blog.thumb} alt={blog.title} className="h-[180px] w-full object-cover" />
							...
							<div className="flex flex-col gap-3 p-6">
								...
								<p className="text-sm leading-relaxed text-gray-600 dark:text-gray-300">{blog.description}</p>
